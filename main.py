...
from handlers.exception_messages_handler import exception_router
...
async def main() -> None:
    ...
    base_router.include_routers(message_request_router, image_request_router, exception_router)
